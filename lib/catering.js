...
// category called "Catering" and kids/camp lunches in one called
// "Kids & Camps". This file only holds the rules Square can't express:
...
export const CATERING = {
  ...
  minPlatterGuests: 10, // no minimum for kids & camps
  noticeHours: 48,
  delivery: {
...
const KIDS_CATEGORY_MATCHES = ['kids & camps', 'kids and camps', 'kids camps', 'kids'];
